...
class PieElement extends BaseElement {
  ...
  static get observedAttributes() {
    return ['delimiter', 'fill', 'height', 'radius', 'width'];
  }
...
class DonutElement extends PieElement {
  ...
  static get observedAttributes() {
    return ['delimiter', 'fill', 'height', 'radius', 'width', 'inner-radius'];
  }
...
class LineElement extends BaseElement {
  ...
  render() {
    if (this.data.length) {
      this.innerHTML = `<svg width="${this.width}" height="${
        this.height
      }"></svg>`;
...
class BarElement extends BaseElement {
  ...
  static get observedAttributes() {
    return ['delimiter', 'fill', 'height', 'max', 'min', 'padding', 'width'];
  }
